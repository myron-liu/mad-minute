...
var startMenu = function(canvas) {
	...
	var step = function() {
		...
		draw();
		if (gameArea.practice) {
			if (gameArea.practiceNumbers.reduce((a, b) => a + b, 0) == 0) {
				buttons.start.deactivate()
		} else {
...
function displayScore() {
	gameArea.constructBlock(gameArea.score, 500, 100, "#f1f1f1", "rgb(0,0,0)", "60px Arial", (gameArea.canvas.width - 100), 0, gameArea.canvas.width - 50, 50)
}
